    ...
    def get_object_tracks(self, frames, read_from_stub=False, stub_path=None):
        ...
        for frame_num, detection in enumerate(detections):
            ...
            for frame_detection in detection_with_tracks:
                ...
                # Atribui jogadores e bola baseando-se nas classes do modelo genérico
                if cls_names[cls_id] == "person":
                    tracks["players"][frame_num][track_id] = {"bbox": bbox}
                
                if cls_names[cls_id] == "sports ball":
    ...
    def draw_annotations(self, video_frames, tracks, team_ball_control):
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            if ball_dict:  # Verifique se o dicionário da bola não está vazio
                ...
                print(f"Bola não detectada no frame {frame_num}. Usando a última posição conhecida.")
                ball_position = last_ball_position  # Mantém a última posição da bola
